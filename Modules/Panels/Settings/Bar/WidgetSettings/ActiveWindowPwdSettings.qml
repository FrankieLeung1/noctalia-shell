...
ColumnLayout {
  ...
  property bool valueDisableResizeAnimation: widgetData.disableResizeAnimation !== undefined ? widgetData.disableResizeAnimation : widgetMetadata.disableResizeAnimation
  ...
  function saveSettings() {
    ...
    settings.disableResizeAnimation = valueDisableResizeAnimation;
  ...
  NToggle {
    Layout.fillWidth: true
    label: "Disable resize animation"
